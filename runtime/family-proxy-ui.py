...
PAGE = PAGE.replace(
    '</style></head>',
    '''.device-header,.device-row{grid-template-columns:minmax(275px,1.42fr) minmax(180px,.86fr) 78px minmax(175px,.86fr) 220px}.device-header span:last-child{text-align:right}.device-action{display:flex;align-items:center;justify-content:flex-end;gap:3px;padding:0 16px!important}.device-action .secondary{min-width:0;padding:7px 7px;background:transparent;color:#0a84ff;white-space:nowrap}.device-action .secondary:hover{background:rgba(10,132,255,.12)}.device-action .action-homekit.is-on,.device-action .action-remove{color:#ff6961}.device-action .action-homekit.is-on:hover,.device-action .action-remove:hover{background:rgba(255,69,58,.12)}.device-action .action-fixed{padding:7px;color:#8e8e93;font-size:12px;white-space:nowrap}@media(max-width:1180px){.device-header,.device-row{grid-template-columns:minmax(225px,1.32fr) minmax(150px,.8fr) 66px minmax(145px,.78fr) 202px}.device-header span,.device-row>div{padding-left:14px;padding-right:14px}.device-action{padding-left:5px!important;padding-right:9px!important}}@media(max-width:860px){.device-header{display:none}.device-action{padding:0!important;justify-content:flex-end;flex-wrap:wrap;max-width:180px}.device-action .secondary,.device-action .action-fixed{padding:5px 6px}}@media(max-width:460px){.device-action{max-width:150px}.device-action .secondary,.device-action .action-fixed{font-size:11px}}</style></head>''',
    1,
)
